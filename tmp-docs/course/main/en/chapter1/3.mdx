...
<h1 id="transformers">Transformers能做什么？</h1>

&amp;lt;CourseFloatingBanner chapter=&amp;lcub;1}
  classNames="absolute z-10 right-0 top-0"
  notebooks=&amp;lcub;[
    &amp;lcub;label: "Google Colab", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/zh-CN/chapter1/section3.ipynb"},
    &amp;lcub;label: "Aws Studio", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/zh-CN/chapter1/section3.ipynb"},
]} />
...
<h2 id="transformer">Transformer被应用于各个方面！</h2>
...
<h2 id="pipelines">使用pipelines</h2>
...
```
```python out
[&amp;lcub;'label': 'POSITIVE', 'score': 0.9598047137260437}]
```
...
```python out
[&amp;lcub;'label': 'POSITIVE', 'score': 0.9598047137260437},
 &amp;lcub;'label': 'NEGATIVE', 'score': 0.9994558095932007}]
```
...
```
```python out
&amp;lcub;'sequence': 'This is a course about the Transformers library',
...
```
```python out
[&amp;lcub;'generated_text': 'In this course, we will teach you how to understand and use '
...
<h2 id="pipeline-hub">在pipeline中使用 Hub 中的其他模型</h2>
...
```
```python out
[&amp;lcub;'generated_text': 'In this course, we will teach you how to manipulate the world and '
                    'move your mental and physical capabilities to your advantage.'},
 &amp;lcub;'generated_text': 'In this course, we will teach you how to become an expert and '
...
```
```python out
[&amp;lcub;'entity_group': 'PER', 'score': 0.99816, 'word': 'Sylvain', 'start': 11, 'end': 18}, 
 &amp;lcub;'entity_group': 'ORG', 'score': 0.97960, 'word': 'Hugging Face', 'start': 33, 'end': 45}, 
 &amp;lcub;'entity_group': 'LOC', 'score': 0.99321, 'word': 'Brooklyn', 'start': 49, 'end': 57}
]
```
...
```
```python out
&amp;lcub;'score': 0.6385916471481323, 'start': 33, 'end': 45, 'answer': 'Hugging Face'}
klyn",
)
...
```
```python out
[&amp;lcub;'summary_text': ' America has changed dramatically during recent years . The '
...
```
```python out
[&amp;lcub;'translation_text': 'This course is produced by Hugging Face.'}]
