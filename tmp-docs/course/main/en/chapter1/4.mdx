...
sections:
- local: transformers
  title: 一点Transformers的发展历史
- local: transformers
  title: Transformers是语言模型
- local: transformer
  title: Transformer是大模型
- local: ''
  title: 迁移学习
- local: ''
  title: 一般的体系结构
...
<h1 id="transformers">Transformers 是如何工作的？</h1>
...
<h2 id="transformers">一点Transformers的发展历史</h2>
...
<h2 id="transformers">Transformers是语言模型</h2>
...
<h2 id="transformer">Transformer是大模型</h2>
