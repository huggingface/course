...
```python out
&amp;lcub;'eval_loss': 1.6964408159255981,
...
```python out
&amp;lcub;'eval_loss': 0.8558505773544312,
...
for epoch in range(num_train_epochs):
    ...
    print(f"epoch &amp;lcub;epoch}, BLEU score: &amp;lcub;results['score']:.2f}")
...
```python out
[&amp;lcub;'translation_text': 'Par défaut, développer les fils de discussion'}]
```
...
```python out
[&amp;lcub;'translation_text': "Impossible d'importer %1 en utilisant le module externe d'importation OFX. Ce fichier n'est pas le bon format."}]
```
