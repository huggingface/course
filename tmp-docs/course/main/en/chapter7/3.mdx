...
sections:
- local: ''
  title: 选择用于掩码语言建模的预训练模型
- local: ''
  title: 数据集
- local: ''
  title: 预处理数据
- local: trainer-api-distilbert
  sections:
  - local: perplexity
    title: 语言模型的perplexity
  title: 使用 `Trainer` API 微调DistilBERT
- local: accelerate-distilbert
  title: 使用 🤗 Accelerate 微调 DistilBERT
- local: ''
  title: 使用我们微调的模型
title: 微调掩码语言模型
---
...
<h2 id="trainer-api-distilbert">使用 `Trainer` API 微调DistilBERT</h2>
...
<h3 id="perplexity">语言模型的perplexity</h3>
...
<h2 id="accelerate-distilbert">使用 🤗 Accelerate 微调 DistilBERT</h2>
