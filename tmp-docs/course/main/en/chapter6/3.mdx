...
for idx, pred in enumerate(predictions):
    ...
    if label != "O":
        results.append(
            &amp;lcub;"entity": label, "score": probabilities[idx][pred], "word": tokens[idx]}
        )
...
```python out
[&amp;lcub;'entity': 'I-PER', 'score': 0.9993828, 'index': 4, 'word': 'S'},
 &amp;lcub;'entity': 'I-PER', 'score': 0.99815476, 'index': 5, 'word': '##yl'},
 &amp;lcub;'entity': 'I-PER', 'score': 0.99590725, 'index': 6, 'word': '##va'},
 &amp;lcub;'entity': 'I-PER', 'score': 0.9992327, 'index': 7, 'word': '##in'},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.97389334, 'index': 12, 'word': 'Hu'},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.976115, 'index': 13, 'word': '##gging'},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.98879766, 'index': 14, 'word': 'Face'},
 &amp;lcub;'entity': 'I-LOC', 'score': 0.99321055, 'index': 16, 'word': 'Brooklyn'}]
```
...
```python out
[&amp;lcub;'entity': 'I-PER', 'score': 0.9993828, 'index': 4, 'word': 'S', 'start': 11, 'end': 12},
 &amp;lcub;'entity': 'I-PER', 'score': 0.99815476, 'index': 5, 'word': '##yl', 'start': 12, 'end': 14},
 &amp;lcub;'entity': 'I-PER', 'score': 0.99590725, 'index': 6, 'word': '##va', 'start': 14, 'end': 16},
 &amp;lcub;'entity': 'I-PER', 'score': 0.9992327, 'index': 7, 'word': '##in', 'start': 16, 'end': 18},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.97389334, 'index': 12, 'word': 'Hu', 'start': 33, 'end': 35},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.976115, 'index': 13, 'word': '##gging', 'start': 35, 'end': 40},
 &amp;lcub;'entity': 'I-ORG', 'score': 0.98879766, 'index': 14, 'word': 'Face', 'start': 41, 'end': 45},
 &amp;lcub;'entity': 'I-LOC', 'score': 0.99321055, 'index': 16, 'word': 'Brooklyn', 'start': 49, 'end': 57}]
```
...
while idx &amp;lt; len(predictions):
    ...
    if label != "O":
        ...
        while (
            idx &amp;lt; len(predictions)
            and model.config.id2label[predictions[idx]] == f"I-&amp;lcub;label}"
        ):
...
```python out
[&amp;lcub;'entity_group': 'PER', 'score': 0.9981694, 'word': 'Sylvain', 'start': 11, 'end': 18},
 &amp;lcub;'entity_group': 'ORG', 'score': 0.97960204, 'word': 'Hugging Face', 'start': 33, 'end': 45},
 &amp;lcub;'entity_group': 'LOC', 'score': 0.99321055, 'word': 'Brooklyn', 'start': 49, 'end': 57}]
```
