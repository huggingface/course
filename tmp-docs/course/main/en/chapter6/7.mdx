...
<h1 id="unigram">Unigram标记化</h1>

&amp;lt;CourseFloatingBanner chapter=&amp;lcub;6}
  classNames="absolute z-10 right-0 top-0"
  notebooks=&amp;lcub;[
    &amp;lcub;label: "Google Colab", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/zh-CN/chapter6/section7.ipynb"},
    &amp;lcub;label: "Aws Studio", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/zh-CN/chapter6/section7.ipynb"},
]} />
...
$$P([``p", ``u", ``g"]) = P(``p") \times P(``u") \times P(``g") = \frac&amp;lcub;5}&amp;lcub;210} \times \frac&amp;lcub;36}&amp;lcub;210} \times \frac&amp;lcub;20}&amp;lcub;210} = 0.000389$$

相比之下,标记化 `["pu", "g"]` 的概率为:

$$P([``pu", ``g"]) = P(``pu") \times P(``g") = \frac&amp;lcub;5}&amp;lcub;210} \times \frac&amp;lcub;20}&amp;lcub;210} = 0.0022676$$
...
token_freqs = &amp;lcub;token: freq for token, freq in token_freqs}
```
...
while len(model) > 100:
    ...
    total_sum = sum([freq for token, freq in token_freqs.items()])
    model = &amp;lcub;token: -log(freq / total_sum) for token, freq in token_freqs.items()}
```
