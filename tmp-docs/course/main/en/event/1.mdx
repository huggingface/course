...
local: part-2
sections:
- local: day-1-transformer-api
  title: 'Day 1: Transformer 的高级API以及如何训练它们'
- local: day-2
  title: 'Day 2: 可以使用的工具'
title: Part 2 发布活动
---
...
<h1 id="part-2">Part 2 发布活动</h1>

对于课程第 2 部分的发布，我们在微调 sprint 之前组织了一场现场活动，为期两天的会谈。 如果你错过了，你可以赶上下面列出的讲座！

<h2 id="day-1-transformer-api">Day 1: Transformer 的高级API以及如何训练它们</h2>
