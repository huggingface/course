...
sections:
- local: pushtohub-api
  title: 使用 push_to_hub API
- local: huggingfacehub-python
  title: 使用 huggingface_hub python库
- local: ''
  title: 使用网络界面
- local: ''
  sections:
  - local: the-uploadfile-approach
    title: The `upload_file` approach
  - local: the-repository-class
    title: The `Repository` class
  - local: the-gitbased-approach
    title: The git-based approach
  title: 上传模型文件
title: 共享预训练模型
---
<script lang="ts">
...
<h2 id="pushtohub-api">使用 push_to_hub API</h2>
...
<h2 id="huggingfacehub-python">使用 huggingface_hub python库</h2>
...
<h3 id="the-uploadfile-approach">The `upload_file` approach</h3>
...
<h3 id="the-repository-class">The `Repository` class</h3>
...
<h3 id="the-gitbased-approach">The git-based approach</h3>
