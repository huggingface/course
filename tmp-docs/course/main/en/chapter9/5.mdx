...
sections:
- local: hugging-face-hub
  title: 从 Hugging Face Hub 加载模型
- local: hugging-face-spaces
  title: 从 Hugging Face Spaces 空间加载
...
<h1 id="hugging-face-hub">与 Hugging Face Hub 整合</h1>
...
<h3 id="hugging-face-hub">从 Hugging Face Hub 加载模型</h3>
...
<h3 id="hugging-face-spaces">从 Hugging Face Spaces 空间加载</h3>
