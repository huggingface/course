...
- local: null
  sections:
  - local: gradio
    title: '打磨你的 Gradio 演示:'
  - local: ''
    title: 使用临时链接分享您的演示
  - local: hugging-face-spaces
    title: 在 Hugging Face Spaces 上托管您的演示
  title: null
- local: ''
  title: ✏️ 让我们应用它!
title: 与他人分享演示
...
<h3 id="gradio">打磨你的 Gradio 演示:</h3>
...
<h3 id="hugging-face-spaces">在 Hugging Face Spaces 上托管您的演示</h3>
