...
<h1 id="datasets">大数据? 🤗 Datasets 来救援!</h1>

&amp;lt;CourseFloatingBanner chapter=&amp;lcub;5}
  classNames="absolute z-10 right-0 top-0"
  notebooks=&amp;lcub;[
    &amp;lcub;label: "Google Colab", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/zh-CN/chapter5/section4.ipynb"},
    &amp;lcub;label: "Aws Studio", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/zh-CN/chapter5/section4.ipynb"},
]} />
...
```python out
&amp;lcub;'meta': &amp;lcub;'pmid': 11409574, 'language': 'eng'},
...
print(f"RAM used: &amp;lcub;psutil.Process().memory_info().rss / (1024 * 1024):.2f} MB")
```
...
```py
print(f"Number of files in dataset : &amp;lcub;pubmed_dataset.dataset_size}")
size_gb = pubmed_dataset.dataset_size / (1024**3)
print(f"Dataset size (cache file) : &amp;lcub;size_gb:.2f} GB")
```
...
print(
    f"Iterated over &amp;lcub;len(pubmed_dataset)} examples (about &amp;lcub;size_gb:.1f} GB) in "
    f"&amp;lcub;time:.1f}s, i.e. &amp;lcub;size_gb/time:.3f} GB/s"
)
```
...
```python out
&amp;lcub;'input_ids': [101, 4958, 5178, 4328, 6779, ...], 'attention_mask': [1, 1, 1, 1, 1, ...]}
```
...
```python out
&amp;lcub;'meta': &amp;lcub;'pmid': 11410799, 'language': 'eng'},
...
[&amp;lcub;'meta': &amp;lcub;'pmid': 11409574, 'language': 'eng'},
  'text': 'Epidemiology of hypoxaemia in children with acute lower respiratory infection ...'},
 &amp;lcub;'meta': &amp;lcub;'pmid': 11409575, 'language': 'eng'},
  'text': 'Clinical signs of hypoxaemia in children with acute lower respiratory infection: indicators of oxygen therapy ...'},
 &amp;lcub;'meta': &amp;lcub;'pmid': 11409576, 'language': 'eng'},
  'text': "Hypoxaemia in children with severe pneumonia in Papua New Guinea ..."},
 &amp;lcub;'meta': &amp;lcub;'pmid': 11409577, 'language': 'eng'},
  'text': 'Oxygen concentrators and cylinders ...'},
 &amp;lcub;'meta': &amp;lcub;'pmid': 11409578, 'language': 'eng'},
...
```python out
&amp;lcub;'meta': &amp;lcub;'case_ID': '110921.json',
...
data_files = &amp;lcub;
    "train": [base_url + "train/" + f"&amp;lcub;idx:02d}.jsonl.zst" for idx in range(30)],
...
```python out
&amp;lcub;'meta': &amp;lcub;'pile_set_name': 'Pile-CC'},
