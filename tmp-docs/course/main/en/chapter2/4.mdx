...
sections:
- local: wordbased
  title: 基于词的(Word-based)
- local: characterbased
  title: 基于字符(Character-based)
- local: ''
  sections:
  - local: ''
    title: 还有更多！
...
<h1 id="tokenizer">标记器（Tokenizer）</h1>
...
<h2 id="wordbased">基于词的(Word-based)</h2>
...
<h2 id="characterbased">基于字符(Character-based)</h2>
...
<h3 id="token-id">从词符(token)到输入 ID</h3>
