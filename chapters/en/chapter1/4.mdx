...
<img class="block dark:hidden" src="../images/finetuning_updated.svg" alt="The fine-tuning of a language model is cheaper than pretraining in both time and money.">

<img class="hidden dark:block" src="../images/finetuning_darkupdated.svg" alt="The fine-tuning of a language model is cheaper than pretraining in both time and money.">
</div>
