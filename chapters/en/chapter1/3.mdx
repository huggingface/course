...
## Conclusion
The pipelines shown in this chapter are mostly for demonstration purposes. They were designed for specific tasks and cannot easily handle variations. In the next chapter, you'll learn what's inside the `pipeline()` function and how to customize its behavior.
