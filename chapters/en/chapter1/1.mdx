...
Currently we do not have any certification for this course. However, we are working on a certification program for the 🤗 Transformers library -- stay tuned!
...
If you have a question about any section of the course, you just have to click on the "*Ask a question*" banner top of the page to be automatically redirected to the right section of the Hugging Face forums to ask it.

<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/forum-button.png" alt="Link to the Hugging Face forums" width="100%">

Note that a list of [project ideas](https://discuss.huggingface.co/c/course/course-event/25) are also available on the forum if you wish to practice more once you have completed the course.

- **Where can I get the codes present in the course?**
For a particular chapter, you just have to click on the banner at the top of the page to access it (either as a Google Colab or as an Amazon SageMaker Studio Lab) for access to a notebook containing all the code presented in the given chapter.

<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/notebook-buttons.png" alt="Link to the Hugging Face course notebooks" width="100%">

The Jupyter notebooks containing all the code from the course are hosted on the [`huggingface/notebooks`](https://github.com/huggingface/notebooks) repo. If you wish to generate them locally, check out the instructions in the [`course`](https://github.com/huggingface/course) repo on GitHub.


- **Where can I contribute to the course?**
Whether it's for practical feedback (a spelling error, a link that doesn't work anymore, etc.), or to contribute to the translation of the course into your native language or for any other feedback, we invite you to go to the GitHub repo of the [course](https://github.com/huggingface/course).

- ** What were the choices made for the each translation?**
Each translation has a glossary and `TRANSLATING.txt` file that details the choices that were made for jargon and tense. You can find an example for German [here](https://github.com/huggingface/course/blob/main/chapters/de/TRANSLATING.txt).


- **Can I reuse this course?**
Of course! The course is released under the permissive [Apache 2 license](https://www.apache.org/licenses/LICENSE-2.0.html).

This means that you must give appropriate credit, provide a link to the license, and indicate if changes were made. You may do so in any reasonable manner, but not in any way that suggests the licensor endorses you or your use.

If you would like to cite the course, please use the following BibTeX:

```
@misc{huggingfacecourse,
  author = {Hugging Face},
  title = {The Hugging Face Course, Spring 2022},
