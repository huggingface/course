...
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/encoder_architecture.svg" alt="An encoder architecture with bidirectional attention." width="600"/>
</div>
...
<div class="flex justify-center">
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/decoder_architecture.svg" alt="A decoder architecture with causal attention." width="600"/>
</div>
...
<div class="flex justify-center">
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/llm_size_evolution.png" alt="Evolution of LLM sizes over time" width="600"/>
</div>
...
<div class="flex justify-center">
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/encoder_decoder_architecture.svg" alt="An encoder-decoder architecture." width="600"/>
</div>
...
An important discovery in the field of language models is that performance scales predictably with model size, dataset size, and compute. These relationships, known as "scaling laws," have driven the development of increasingly large models.

<div class="flex justify-center">
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/scaling_laws.png" alt="Scaling laws showing how performance improves with model size" width="600"/>
</div>

Key insights from scaling laws:

- Model performance improves as a power law with model size
- Larger models are more sample-efficient (they need fewer examples to learn)
- There are diminishing returns, but we haven't yet hit a plateau
- Compute-optimal training allocates more tokens to smaller models and fewer tokens to larger models

These insights have guided researchers in developing more efficient training strategies and determining optimal model sizes for different applications.
