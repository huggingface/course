...
model_ckpt = "sentence-transformers/multi-qa-mpnet-base-dot-v1" # by using "sentence-transformers/msmarco-distilbert-base-dot-prod-v3" we seem to have a better score
tokenizer = AutoTokenizer.from_pretrained(model_ckpt)
