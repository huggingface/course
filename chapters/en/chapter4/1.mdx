...
The techniques introduced in this chapter will prepare you for the section in [Chapter 5](/course/chapter5/6) where we look at creating a language model for Python source code. Let's start by looking at what it means to "train" a tokenizer in the first place.