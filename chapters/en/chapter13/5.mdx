...
![Reward from reward function](https://huggingface.co/reasoning-course/images/resolve/main/grpo/12.png)
...
![Loss](https://huggingface.co/reasoning-course/images/resolve/main/grpo/13.png)
