...
<img src="https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter6/IOB_versions.PNG" alt="IOB1 vs IOB2 format" width="80%"/>
</div>
