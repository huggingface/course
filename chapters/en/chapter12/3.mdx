...
<iframe
	src="https://huggingface.co/chat/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-32B"
	frameborder="0"
	width="850"
	height="450"
></iframe>

If you want to try it for yourself, you can also deploy the model yourself using the [Hugging Face Inference](https://reasoning-course-deepseek-ai-deepseek-r1-distill-0f5fad4.hf.space).
