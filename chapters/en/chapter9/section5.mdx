...
Remember this demo that removes the background of an image from section 1? Let's load it from Hugging Face spaces:
...
One of the cool things about loading demos from Spaces is that you customize them by overriding any of the 
