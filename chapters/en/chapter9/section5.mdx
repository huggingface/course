To make your life even easier, gradio integrates directly with Hugging Face Hub and Hugging Face Spaces. You can load and edit models and spaces with only one line of code.

### Load models from the Hugging Face Hub
Browse through the thousands of models Hugging Face has to offer as described in [Chapter 4](/course/chapter4/section2).
...
Remember this gradio interface that removes the background of an image from section 1?

<iframe src="https://hf.space/gradioiframe/abidlabs/remove-bg/+" frameBorder="0" height="550" title="Gradio app" class="container p-0 flex-grow space-iframe" allow="accelerometer; ambient-light-sensor; autoplay; battery; camera; document-domain; encrypted-media; fullscreen; geolocation; gyroscope; layout-animations; legacy-image-formats; magnetometer; microphone; midi; oversized-images; payment; picture-in-picture; publickey-credentials-get; sync-xhr; usb; vr ; wake-lock; xr-spatial-tracking" sandbox="allow-forms allow-modals allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-downloads"></iframe>

Let's load this Hugging Face space and customize it to work with a webcam instead:
