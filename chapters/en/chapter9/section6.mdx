...
page load. Furthermore, data is not shared between different users of your model. 

Session state is useful for building demos for things like chatbots where you want to
