...
### Polishing your `gradio` demo:
  - Now you might notice that our interfaces looks too basic and plain. How can we add more to our demos? The `Interface` class supports some optional parameters:
