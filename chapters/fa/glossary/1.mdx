...
| Label | برچسب |
| Padding | هم‌طول‌سازی |
| Dynamic padding | هم‌طول‌سازی پویا |
...
- Keep voice active and consistent. Don't overdo it but try to avoid a passive voice.
...
- Smaller sentences are better sentences. Apply with nuance.
