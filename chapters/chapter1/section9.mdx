...
In this chapter, you saw how to approach different NLP tasks using the high-level 🤗 Transformers `pipeline` API. You also saw how to search for and use models in the Hub, as well as how to use the Inference API to test the models directly in your browser.
