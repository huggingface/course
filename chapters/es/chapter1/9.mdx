...
En este capítulo viste cómo abordar diferentes tareas de PLN usando la función de alto nivel `pupeline()` de 🤗 Transformers. También viste como buscar modelos en el Hub, así como usar la API de Inferencia para probar los modelos directamente en tu navegador.
