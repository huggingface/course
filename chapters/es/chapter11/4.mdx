...
Los métodos PEFT pueden combinarse con TRL para reducir los requisitos de memoria durante el ajuste fino. Podemos pasar la `LoraConfig` al modelo al cargarlo.
