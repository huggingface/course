...
<Question
	choices={[
		...
		{
			text: "Un componente adicional, compuesto usualmente de una o unas pocas capas, para convertir las predicciones del Transformer a una salida específica de la tarea",
