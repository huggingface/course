...
# Use batched=True to activate fast multithreading! [[Use batched=True to activate fast multithreading!]]
...
tf_eval_dataset = d model.prepare_tf_dataset(
...
batch_size = 64
# Show the training loss with every epoch [[Show the training loss with every epoch]]
