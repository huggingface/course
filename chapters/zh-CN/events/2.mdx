...
Lewis 是 Hugging Face 的机器学习工程师，专注于开发开源工具并让更广泛的社区可以访问它们。 他还是 O'Reilly 即将出版的有关于Transform的合著者，你可以在 Twitter (@_lewtun) 上关注他，了解 NLP 提示和技巧！
...
**Lucile Saulnier:** *使用 🤗 Transformers 和 🤗 Tokenizers 获取你自己的tokenizer*
...
**Sylvain Gugger:** *使用 🤗 Accelerate* 增强你的 PyTorch 训练循环*
