...
위의 그림을 살펴보겠습니다. 손실 곡선(왼쪽)과 해당 정확도 곡선(오른쪽)을 모두 표시합니다. 이러한 곡선은 뚜렷한 특성을 가지고 있습니다.
...
학습 곡선의 몇 가지 실용적인 예시를 살펴보겠습니다. 먼저 훈련 중 학습 곡선을 모니터링하는 몇 가지 접근 방식을 강조하겠습니다. 아래에서는 학습 곡선에서 관찰할 수 있는 다양한 패턴을 분해하겠습니다.
...
### 5. 모델이 부적합일 수 있음을 나타내는 것은 무엇인가요?
...
<Question
	choices={[
		...
		},
		{
			...
			explain: "부드러운 곡선은 일반적으로 좋은 것이며 부적합을 나타내지 않습니다."
		},
        {
