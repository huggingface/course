...
Nous vous avons déjà montré comment vous pouvez utiliser le modèle que nous avons affiné sur le *Hub* avec le widget d'inférence. Pour l'utiliser localement dans une `pipeline`, vous devez juste spécifier l'identifiant de modèle approprié :
