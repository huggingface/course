...
<Question
	choices={[
		...
		},
		{
			...
			explain: "Correct ! Vous pouvez passer la fonction de rassemblement comme argument d'une fonction <code>DataLoader</code>. Nous avons utilisé la fonction <code>DataCollatorWithPadding</code> qui remplit tous les éléments d'un batch pour qu'ils aient la même longueur.",
            correct: true
		},
		{
