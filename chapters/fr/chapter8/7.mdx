...
<Question
	choices={[
		...
		{
			text: "De bas en haut",
			explain: "Correct ! L'avantage des <i>traceback</i> de Python montrant l'exception en bas est qu'il est plus facile de déboguer lorsque vous travaillez dans le terminal et que c'est la dernière ligne que vous voyez.",
			correct: true
		}
	]}
/>
...
<Question
	choices={[
		{
			text: "Une mise en œuvre simple de l'architecture d'un <i>transformer</i> à partir d'un article de recherche.",
...
<Question
	choices={[
		...
		},
		{
			...
			explain: "Bon choix ! Ce titre est concis et donne au lecteur un indice sur ce qui pourrait être erroné (par exemple, que GPT-3 n'est pas pris en charge dans 🤗 <i>Transformers</i>).",
			correct: true
		},
		{
...
<Question
	choices={[
		{
			text: "Postez un exemple complet et reproductible du bogue.",
			explain: "Oui, c'est la meilleure façon d'aider les mainteneurs à trouver votre bogue. Que devez-vous faire d'autre ?",
			correct: true
		},
		{
