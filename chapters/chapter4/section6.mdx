...
<Question
	hydrate-props={{ choices: [
		...
		{
			text: "Run 'transformers-cli login' in a terminal.",
			explain: "Correct — this will download and cache your personal token. There's another way to achieve this, though!",
            correct: true
		},
		{
