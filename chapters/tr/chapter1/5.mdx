...
Encoder modelleri cümle sınıflandırma, varlık tanıma (ve daha genel olarak sözcük sınıflandırma) ve çıkarımsal soru yanıtlama gibi cümlenin tam anlaşılmasını gerektiren görevler için uygundur.
