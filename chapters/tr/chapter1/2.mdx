...
- **Cümle içerisindeki her bir kelimenin sınıflandırılması:** Bir cümlenin dilbilgisel öğelerinin (isim, fiil, sıfat), ya da isim verilmiş varlıkların tanımlanması
...
- **Metinden cevap çıkarımı:** Verilen bir soru ve bağlamı kullanarak, bağlamda verilmiş olan bilgiye dayanarak verilen soruyu cevaplama
