...
- **Разработчики машинного обучения** смогут легко представить свою работу широкой аудитории, включая нетехнические команды или клиентов.
- **Исследователи** смогут легче воспроизводить модели машинного обучения и их поведение
...
* Экстрактивная модель **ответа на вопрос**, которая принимает контекстный параграф и задание и выдает ответ и оценку вероятности (мы обсуждали этот тип модели [в главе 7](/course/chapter7/7)):
