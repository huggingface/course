# Обращение за помощью на форумы[[asking-for-help-on-the-forums]]
...
Форумы [Hugging Face](https://discuss.huggingface.co) - это отличное место, где можно получить помощь от команды разработчиков с открытым исходным кодом и более широкого сообщества Hugging Face. Вот как выглядит главная страница в любой день:
...
Теперь предположим, что мы попытаемся построить векторное представления для целого раздела [статьи с Википедии](https://en.wikipedia.org/wiki/Transformers), посвященной Трансформерам (модели, а не библиотеке!):
...
О-о, мы столкнулись с проблемой - и сообщение об ошибке гораздо более загадочно, чем те, что мы видели в [разделе 2](2.mdx)! Мы не можем разобраться в полном её описании, поэтому решили обратиться за помощью на форум Hugging Face. Как мы можем создать тему?
...
### Выбор содержательного названия[[choosing-a-descriptive-title]]
...
### Форматирование кода[[formatting-your-code-snippets]]
...
### Включение в текст полной трассировки[[including-the-full-traceback]]
...
### Предоставление воспроизводимого примера[[providing-a-reproducible-example]]
