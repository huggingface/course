...
Wenn du für das Modell-Training Keras benutzt, der einfachste Weg, um das Modell aud den Hub hochzuladen, ist den `PushToHubCallback` zu setzen, wenn du `model.fit()` aufrufst.
