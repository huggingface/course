...
|-----------------|--------------------------------------------|----------------------------------------------------------------------------------|
| Encoder         | ALBERT, BERT, DistilBERT, ELECTRA, RoBERTa | Klassifizierung von Sätzen, Eigennamenerkennung/NER, Extraktives Question Answering |
| Decoder         | CTRL, GPT, GPT-2, Transformer XL           | Textgenerierung                                                                  |
| Encoder-Decoder | BART, T5, Marian, mBART                    | Automatische Textzusammenfassung, Maschinelle Übersetzung, Generatives Question Answering                        |
