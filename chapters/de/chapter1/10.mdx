...
### 11. Welche mögliche Ursache kann eine in einem Modell zu beobachtende statistische Verzerrung (Bias) haben(#M# ein Modell voreingenommen werden lassen, Wodurch wird ein Bias eines Modells verursacht?, Aus welchem Grund)?
