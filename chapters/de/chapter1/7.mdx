...
Encoder-Decoder-Modelle (auch *Sequence-to-Sequence-Modelle* genannt) verwenden beide Teile der Transformer-Architektur. Die Attention Layer des Encoders können in jeder Phase auf alle Wörter des Ausgangssatzes zugreifen, während die Attention Layer des Decoders nur auf die Wörter zugreifen können, die vor einem bestimmten Wort des Inputs stehen.
