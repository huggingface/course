...
Decoder-Modelle verwenden nur den Decoder eines Transformer-Modells. Die Attention Layer können in jeder Phase(#M Zu jeder Zeit#) für ein bestimmtes Wort nur auf die Wörter zugreifen, die vor diesem Wort im Satz stehen. Diese Modelle werden oft als *autoregressive Modelle* bezeichnet.
