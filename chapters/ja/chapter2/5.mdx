...
前のセクションでは、最も単純な使用例である、小さな長さの単一のシーケンスに対する推論を調べました。 しかし、すでにいくつかの質問が生じています。
...
# This line will fail.
model(input_ids)<FrameworkSwitchCourse {fw} />
...
sequence = "I've been waiting for a HuggingFace course my wh<FrameworkSwitchCourse {fw} />
