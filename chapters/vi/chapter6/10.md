...
<Question
	choices={[
		...
		{
			text: "WordPiece tokenizer học các quy tắc hợp nhất bằng cách gộp các cặp token tối đa hoá điểm của các cặp tần suất cao so với các phần cá nhân có tần suất ít hơn.",
			explain: "Chính xác!",
			correct: true
		},
		{
