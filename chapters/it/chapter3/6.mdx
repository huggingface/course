...
<Question
	choices={[
		{
			text: "Joy (Gioia)",
			explain: "Prova ancora — questa emozioni è contenuta nel dataset!"
		},
		{
			text: "Love (Amore)",
			explain: "Prova ancora — questa emozioni è contenuta nel dataset!"
...
<Question
	choices={[
		{
			text: "Quando si applica in ogni batch il padding fino alla lunghezza massima dell'intero dataset",
			explain: "Coinvolge il padding per ogni batch, ma non fino alla lunghezza massima dell'intero dataset."
		},
		{
			text: "Quando si applica in ogni batch il padding fino alla lunghezza massima delle frasi in quella batch",
		...
		{
			text: "Quando si applica il padding agli input in modo che ogni frase abbia lo stesso numero di token della frase precedente nel dataset.",
...
<Question
	choices={[
		{
			text: "Per assicurarsi che tutte le sequenze nel dataset abbiano la stessa lunghezza.",
		...
		{
			text: "Per raccogliere tutti i campioni in una batch.",
		...
		{
			text: "Per preprocessare l'intero dataset",
			explain: "Quella sarebbe una funzione di preprocessing, non di raccolta."
		},
        {
			text: "Per troncare le sequenze nel dataset.",
...
<Question
	choices={[
        ...
        {
			text: "Nulla, poiché il modello può comunque essere affinato per un compito differente.",
