...
Il pre-addestramento di questi modelli può essere fatto utilizzando gli obbiettivi dei modelli encoder o decoder, anche se solitamente include un livello di complessità maggiore. Ad esempio, [T5](https://huggingface.co/t5-base) è pre-addestrato rimpiazzando porzioni random di testo (che possono contenere più di una parola) con una speciale mask word, con l'obbiettivo di predirre il testo rimpiazzato dalla mask word stessa.
