	...
	choices={[
		{
			...
			explain: "Sbagliato! Se così fosse, si tratterebbe di una pipeline <code>sentiment-analysis</code>."
		},
		{
			text: "Genera e restituisce testo che completa la frase di partenza.",
			explain: "Sbagliato! Se così fosse, si tratterebbe di una pipeline <code>text-generation</code>.",
		},
		{
