...
- ai **ricercatori** di riprodurre più facilmente i modelli e i meccanismi di machine learning
...
* Un modello di **riconoscimento di disegni** che riceve uno schizzo di un disegno e restituisce i nomi di ciò che pensa sia stato disegnato:
...
Se vuoi mettere a frutto le conoscenze acquisite in questo capitolo, partecipa al Gradio blocks party! Si tratta di un evento della community organizzato da Hugging Face **dal 16 al 31 maggio**. Durante l'evento, potrai costruire demo di machine learning con Gradio e partecipare alla gara per vincere premi e gadget di Hugging Face!

Consulta la [descrizione dell'evento](https://github.com/AK391/community-events/blob/main/gradio-blocks/README.md) per i dettagli su come partecipare - non vediamo l'ora di vedere cosa creerai 🤗!